...
- Respect project rules and memory, but be critical of them if they seem flawed or outdated
...
- `vcs_cli`: gh (detected from git remote, do not re-detect if present)
